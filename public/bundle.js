...
var React = __webpack_require__(2); // require thư viện React
var ReactDom = __webpack_require__(32); // require thư viện ReactDom

var _require = __webpack_require__(9),
    Provider = _require.Provider; // es6 destructuring: tao 1 bien = ten thuoc tinh
...
var _NoteForm = __webpack_require__(71);
  ...
  _createClass(List, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_NoteForm2.default, { addFunc: this.addNote }),
  ...
  _createClass(Note, [{
    ...
    value: function del() {
      var _props = this.props,
          index = _props.index,
          dispatch = _props.dispatch; // lay bien co ten index trong props va cho vao mot bien moi co ten index

      dispatch((0, _action.delItem)(index));
    }
  }, {
    key: 'render',
    value: function render() {
...
function delItem(index) {
  return { type: "DEL_ITEM", index: index }; // ES6: Rut gon khi tao mot bien = bien cung ten
}
function toogleIsAdding() {
  return { type: "TOGGLE_IS_ADDING" };
}

module.exports = { addItem: addItem, delItem: delItem, toogleIsAdding: toogleIsAdding };
...
var NoteForm = function (_React$Component) {
  ...
  _createClass(NoteForm, [{
    ...
    value: function add(e) {
      ...
      dispatch((0, _action.toogleIsAdding)());
      this.refs.txt.value = '';
    }
  }, {
    key: 'showAddForm',
    value: function showAddForm() {
      var dispatch = this.props.dispatch; // tat ca cac com trong Com Provider duoc thua huong dispatch
    ...
    value: function render() {
      if (this.props.isAdding) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement('input', { type: 'text', ref: 'txt', placeholder: 'Input Your Note!' }),
          _react2.default.createElement(
            'button',
            null,
            'Add'
...
var redux = __webpack_require__(11);
var mangReducer = __webpack_require__(74);
var isAddingReducer = __webpack_require__(75);
...
var mangReducer = function mangReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : ['Android', 'iOS', 'React'];
  var action = arguments[1];

  switch (action.type) {
    case 'ADD_ITEM':
      return [].concat(_toConsumableArray(state), [action.item]); // lay thuoc tinh item tu action dua vao mang
    case 'DEL_ITEM':
      return state.filter(function (e, i) {
        return i != action.index;
      }); //Neu i == index tra ve false va loai item do ra
    default:
      return state;
  }
};
...
var isAddingReducer = function isAddingReducer() {
  ...
  switch (action.type) {
    case 'TOGGLE_IS_ADDING':
      // neu chi thi la TOOGLE_IS_ADDING thi lay state cu va phu dinh gia tri
      return !state;
    default:
      return state;
  }
